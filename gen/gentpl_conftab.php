...
$tbtypes=array(
	...
	"text" => array(
		"size" => 30, "colwidth" => 100, "list" => 1,"menu"=>null,"typebdd"=>"text",
	...
	"longtext" => array(
		...
		"href"=>"{tablename}.php?action=edit&{tbid}=[!{tbid}!]","type_href"=>1,
		"size"=>16000, "colwidth" => 100, "list" => 0,"menu"=>null,"flag_search"=>0),
	"html" => array(
		"typebdd"=>"text","height" => 400,"width" => 600,"flag_noedit"=>1,
		"href"=>"{tablename}.php?action=edit&{tbid}=[!{tbid}!]","type_href"=>1,
		"size"=>16000, "colwidth" => 100, "list"=>0, "flag_search"=>0),
	"photo" => array(
...
$tbtypes_help=array(
	...
	"colwidth" => "largeur de la colonne (TD) à afficher, si noedit=1",
